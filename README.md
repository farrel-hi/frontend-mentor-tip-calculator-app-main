...
## Overview
This repository contains my personal solution for [Tip Calculator App](https://www.frontendmentor.io/challenges/tip-calculator-app-ugJNGbJUX).
...
- Solution URL: [GitHub Solution URL here](https://github.com/farrel-hi/frontend-mentor-tip-calculator-app-main)
- Live Site URL: [Live site URL here](https://farrel-hi.github.io/frontend-mentor-tip-calculator-app-main/)

## My process
1. Create the HTML semantic structure first
2. Create the mobile rules first and then the desktop rules second using CSS
3. Create the function for calculating the tip and other functions using JavaScript
